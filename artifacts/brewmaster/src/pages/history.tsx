...
import { Activity, Bell, Settings2, CheckCircle2, AlertTriangle, Clock } from "lucide-react";
    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">Immutable chronological event history.</p>
        </div>
      </div>
      ...
      <div className="bg-sidebar border border-border/50 rounded-lg shadow-xl overflow-hidden">
        <div className="divide-y divide-border/50">
          {history?.map(event => (
            <div key={event.id} className="p-4 flex items-start gap-4 hover:bg-card/30 transition-colors">
              ...
              <div className="flex-1 space-y-1">
                ...
                {(event.productionId || event.equipmentId) && (
                  <div className="flex gap-3 mt-2 text-[10px] uppercase font-mono tracking-widest text-muted-foreground">
